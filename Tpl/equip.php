...
function delEquip( obj )
{
	if( confirm( "是否要删除此装备"))
	{	
		window.location.href="Admin.php?act=equip&oper=delEquip&tag="+obj.id;
	}
}
            ...
            <table class="table table-bordered table-striped with-check">
              <thead>
                <tr>
                  ...
                  <th style="width:30px" ><label class="control-label">英雄ID</label></th>
              	...
              	?>
	                <tr>
	                  ...
	                  <td>
	                  	...
	                  	<button id="delEquip_<?php echo $info['id'];?>" class="btn btn-success btn-mini" onclick="delEquip(this)" >删除</button>
	                  </td>
