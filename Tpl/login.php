...
<head>
        ...
        <link rel="stylesheet" href="../Tpl/css/matrix-login.css" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="http://themedesigner.in/demo/matrix-admin/index.html">
				 <div class="control-group normal_text"> <h3><img src="../Tpl/img/logo.png" alt="Logo" /></h3></div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" href="?method=Index.index" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
        ...
        <script src="../Tpl/js/matrix.login.js"></script> 
    </body>
